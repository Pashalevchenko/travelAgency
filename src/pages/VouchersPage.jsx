...
import { Container, Row, Col, Card, Button, Spinner, Alert, Badge, Form, Pagination } from 'react-bootstrap';
...
export default function VouchersPage() {
  ...
  const [filters, setFilters] = useState({ tourType: "", transferType: "", hotelType: "", price: "" });
    ...
    <Container className="py-4">
        ...
        <Card.Body>
          <Form>
            <Row className="g-3">
              <Col md={3}>
                <Form.Group>
                  ...
                  <Form.Select name="tourType" value={filters.tourType} onChange={handleFilterChange}>
              ...
              <Col md={3}>
                <Form.Group>
                  ...
                  <Form.Select name="transferType" value={filters.transferType} onChange={handleFilterChange}>
              ...
              <Col md={3}>
                <Form.Group>
                  ...
                  <Form.Select name="hotelType" value={filters.hotelType} onChange={handleFilterChange}>
            ...
            <div className="mt-3 text-end">
              <Button variant="secondary" size="sm" onClick={() => setFilters({tourType:"", transferType:"", hotelType:"", price:""})}>
                Reset Filters
              </Button>
            </div>
          </Form>
      ...
      {errorBalance && 
       <Alert variant="danger" onClose={() => setErrorBalance(false)} dismissible>
        ...
        <p>
          Just work and one day you will chill 😌🏝️
        </p>
      </Alert>
      }
           ...
           <Col key={v.id}>
                <Card className="h-100 shadow-sm border-0">
                  <Card.Body className="d-flex flex-column">
                    ...
                    <Card.Subtitle className="mb-3 text-success fw-bold">
                      ${v.price}
                    </Card.Subtitle>
                    <Card.Body>
                    ...
                    <div className="mt-auto">
                      {isAdmin ? (
                        ...
                        <>
                          ...
                          {/* Если юзер владелец — даем и ему удалить */}
